...
public class Estudiante {
	...
	public void retirarLibro(Libro libro, Biblioteca biblioteca)
			...
			YaRetiroMasDeDosLibrosException, NoCoincideElEstudianteConElTipoDeLibro {
		...
		if (!libro.evaluarCondicion(this)) {
			throw new NoCoincideElEstudianteConElTipoDeLibro("No puede retirar el libro por no coincidir estudiante");
		}
		libro.setCantidadCopias(libro.getCantidadCopias() - 1);
		biblioteca.getPrestamos().add(new Prestamo(this.dni, libro.getCodigoLibro()));// es necesario crear un
